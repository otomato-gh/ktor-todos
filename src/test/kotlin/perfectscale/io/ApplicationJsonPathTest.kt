package io.perfectscale

import com.jayway.jsonpath.DocumentContext
import com.jayway.jsonpath.JsonPath
import io.ktor.client.*
import io.perfectscale.model.Priority
...
class ApplicationJsonPathTest {
    @Test
    fun todosCanBeFound() = testApplication {
        val jsonDoc = client.getAsJsonPath("/todos")
    ...
    @Test
    fun todosCanBeFoundByPriority() = testApplication {
        val priority = Priority.Medium
        val jsonDoc = client.getAsJsonPath("/todos/byPriority/$priority")
